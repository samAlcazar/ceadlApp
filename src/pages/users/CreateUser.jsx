  ...
  return (
    <main className='w-screen h-screen flex flex-col justify-center items-center bg-gray-100'>
      <section className='flex flex-col justify-center items-center w-[1200px] h-full bg-gradient-to-t from-cyan-900 to-cyan-700 overflow-y-auto'>
        <h1 className='text-white text-2xl mb-8'>Crear Usuario</h1>
            ...
            <fieldset className='border border-cyan-300 rounded-lg p-4'>
              ...
              <div className='flex flex-col gap-4'>
                <label className='grid text-cyan-50'>
                  ...
                  <select name='idProfile' required className='px-2 py-1 mt-1 rounded-md bg-cyan-700 text-white'>
                ...
                <label className='grid text-cyan-50'>
                  ...
                  <select name='idProject' className='px-2 py-1 mt-1 rounded-md bg-cyan-700 text-white'>
        ...
        <section className='mt-4 w-3/4'>
          <p className='text-center text-cyan-50'>
            {newUser !== null ? 'El usuario se ha creado con éxito' : 'Aún no se ha creado el usuario'}
          </p>
          <div className='text-center mt-4' style={{ display: newUser !== null ? 'block' : 'none' }}>
