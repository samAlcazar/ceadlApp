...
const CreateSurrender = () => {
  ...
  return (
    <main className='w-screen h-screen flex flex-col justify-center items-center bg-gray-100'>
      <h1>Crear Surrender</h1>
      <div>
        <strong>ID Accountability:</strong> {idAccountability || 'No definido'}
      </div>
      ...
      <form>
        ...
        <button type='button' onClick={pushSurrender}>Agregar Surrender</button>
      </form>

      <section>
        <h2>Surrenders Agregados</h2>
      ...
      <button onClick={handleSubmit}>Subir Todos los Surrenders</button>

      <section>
        <h2>Surrenders Subidos</h2>
